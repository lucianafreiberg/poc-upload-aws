...
import com.lucianafreiberg.pocupload.domain.exception.UploadFailedException;
...
public class UploadResource {
    ...
    public Mono<ResponseEntity<UploadResult>> uploadHandler(@RequestHeader HttpHeaders headers, @RequestBody Flux<ByteBuffer> body) {
        ...
        if (length < 0) {
            throw new UploadFailedException(HttpStatus.BAD_REQUEST.value(), Optional.of("requerid: Content-Length"));
        }
        ...
        return Mono.fromFuture(future)
                .map((response) -> {
                    ...
                    return ResponseEntity
                            ...
                            .body(new UploadResult(HttpStatus.CREATED, Arrays.asList(new String[]{fileKey})));
                });
    }
